...
[ApiController]
[ApiVersion("1.0")]
[Route("api/v{version:apiVersion}/admin/cms/popular-destinations")]
[Authorize(Roles = "Admin")]
public class PopularDestinationController : ControllerBase
{
    private readonly IPopularDestinationService _service;
    public PopularDestinationController(IPopularDestinationService service) => _service = service;
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] CreatePopularDestinationDto dto, CancellationToken ct)
    {
    ...
    [HttpPut("{id:guid}")]
    public async Task<IActionResult> Update(Guid id, [FromBody] UpdatePopularDestinationDto dto, CancellationToken ct)
