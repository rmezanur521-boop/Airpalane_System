...
[ApiController]
[ApiVersion("1.0")]
[Route("api/v{version:apiVersion}/admin/cms/travel-services")]
[Authorize(Roles = "Admin")]
public class TravelServiceController : ControllerBase
{
    private readonly ITravelServiceService _service;
    public TravelServiceController(ITravelServiceService service) => _service = service;
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] CreateTravelServiceDto dto, CancellationToken ct)
    {
    ...
    [HttpPut("{id:guid}")]
    public async Task<IActionResult> Update(Guid id, [FromBody] UpdateTravelServiceDto dto, CancellationToken ct)
